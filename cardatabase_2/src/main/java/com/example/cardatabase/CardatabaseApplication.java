...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		userRepository.save(new AppUser("user", "$2a$12$iaX.GGwrdDua.fmovSFix.F.eiAq915arr7jVgeGLyNyladzZ2nCK", "USER"));
		// username:admin / password : admin
		userRepository.save(new AppUser("admin","$2a$12$xjHCmhpb2z2AYRmxFxe7weR1jme0nG.M8pQ0mZs0N1LZJdmXcjQlO","ADMIN"));
